...
export const resetAllLocalSettings = () => {
    const keysToClear = [
        apiSettings.STORAGE_KEY,
        recentActivityManager.STORAGE_KEY,
        themeManager.STORAGE_KEY,
        themeManager.CUSTOM_THEME_KEY,
        lastFMStorage.STORAGE_KEY,
        lastFMStorage.LOVE_ON_LIKE_KEY,
        lastFMStorage.SCROBBLE_PERCENTAGE_KEY,
        lastFMStorage.CUSTOM_API_KEY,
        lastFMStorage.CUSTOM_API_SECRET,
        lastFMStorage.USE_CUSTOM_CREDENTIALS_KEY,
        nowPlayingSettings.STORAGE_KEY,
        lyricsSettings.DOWNLOAD_WITH_TRACKS,
        backgroundSettings.STORAGE_KEY,
        dynamicColorSettings.STORAGE_KEY,
        cardSettings.COMPACT_ARTIST_KEY,
        cardSettings.COMPACT_ALBUM_KEY,
        replayGainSettings.STORAGE_KEY_MODE,
        replayGainSettings.STORAGE_KEY_PREAMP,
        downloadQualitySettings.STORAGE_KEY,
        coverArtSizeSettings.STORAGE_KEY,
        waveformSettings.STORAGE_KEY,
        ...
        playlistSettings.CUE_KEY,
        playlistSettings.NFO_KEY,
        playlistSettings.JSON_KEY,
        playlistSettings.RELATIVE_PATHS_KEY,
        visualizerSettings.SENSITIVITY_KEY,
        visualizerSettings.SMART_INTENSITY_KEY,
        visualizerSettings.ENABLED_KEY,
        visualizerSettings.MODE_KEY,
        visualizerSettings.PRESET_KEY,
        visualizerSettings.BUTTERCHURN_CYCLE_KEY,
        equalizerSettings.ENABLED_KEY,
        equalizerSettings.GAINS_KEY,
        equalizerSettings.PRESET_KEY,
        fontSettings.STORAGE_KEY,
        fontSettings.CUSTOM_FONTS_KEY,
        pwaUpdateSettings.STORAGE_KEY,
        musicProviderSettings.STORAGE_KEY,
        queueBehaviorSettings.STORAGE_KEY,
        analyticsSettings.ENABLED_KEY,
        contentBlockingSettings.BLOCKED_ARTISTS_KEY,
        contentBlockingSettings.BLOCKED_TRACKS_KEY,
        contentBlockingSettings.BLOCKED_ALBUMS_KEY,
        'sidebar-menu-order',
        'sidebar-show-home',
        'sidebar-show-library',
        'sidebar-show-recent',
        'sidebar-show-unreleased',
        'sidebar-show-donate',
        'sidebar-show-settings',
        'sidebar-show-account',
        'sidebar-show-about',
        'sidebar-show-download',
        'sidebar-show-discord',
        'audio-effects-speed',
        'audio-effects-pitch',
        'audio-effects-preserve-pitch',
        'mono-audio-enabled',
        'exponential-volume-enabled',
        'home-show-recommended-songs',
        'home-show-recommended-albums',
        'home-show-recommended-artists',
        'home-show-jump-back-in',
        'home-show-editors-picks',
        'home-shuffle-editors-picks',
        'volume',
        'monochrome-queue',
        'playback-quality',
        'lyricsRomajiMode',
        ...
        'maloja-enabled',
        'monochrome-settings-passphrase',
        'monochrome-persisted-passphrase',
        'monochrome-persisted-passphrase-key',
    ];
